...
- One tokenizer, the common one: byte-pair-encoding subwords learned from your own text — Chapter 1 has a player that performs the merges one at a time; prompts are tokenised the same way.
